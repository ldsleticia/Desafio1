...
public class Main {
    ...
    static TreeSet<Produto> estoque = Uteis.getProdutos();
   ...
   public static void main(String[] args) throws InterruptedException {
    ...
    private static void mostrarEstoque() {
        ...
        do{ System.out.printf("%10s************************************************************\n",esp);
            ...
            for(Produto p : estoque){
                System.out.printf("%15s%5s%d%8s%"+ Uteis.tamanhoMaiorString(estoque)+"s%9d%6sR$%.2f\n",esp,esp,
    ...
    private static void mostrarNotaFiscal(int i) throws InterruptedException {
        ...
        do{ System.out.printf("%10s*************************************************************\n",esp);
            ...
            for(Produto p : cliente.getCompras().getProdutos()){
                System.out.printf("%10s%-10d%"+ Uteis.tamanhoMaiorString(cliente.getCompras().getProdutos())+
